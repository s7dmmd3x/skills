...
- For personal projects, default to Minimal APIs over controller-based APIs — less boilerplate and easier to follow when learning.
- When suggesting auth patterns, lean toward cookie-based auth with ASP.NET Core Identity for server-rendered apps; JWT bearer for pure API projects.
